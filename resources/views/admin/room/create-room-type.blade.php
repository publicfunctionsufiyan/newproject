      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Room Type</h1>
            <a href="{{ url('admin-room-types') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">View All</a>
          </div>
          <div class="container"> 
