...
<!-- Sidebar - Brand -->
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('welcome-admin') }}">
...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="{{ url('admin-hotels') }}">Hotels</a>
...
<li class="nav-item">
        <a class="nav-link" href="{{ url('user-reviews') }}">
          <i class="fas fa-fw fa-table"></i>
          <span>Reviews</span></a>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Amenities</h1>
            <a href="{{ url('admin-amenities') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">View All</a>
          </div>
          <div class="container"> 
